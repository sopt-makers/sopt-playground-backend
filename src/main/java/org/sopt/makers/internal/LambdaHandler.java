...
public class LambdaHandler implements RequestStreamHandler {
    ...
    public void handleRequest(InputStream inputStream, OutputStream outputStream, Context context)
        ...
        // System.out.println("Request details: " + inputString.substring(0, Math.min(inputString.length(), 500)));

        try {
            // 먼저 응답을 버퍼에 캡처하여 디버깅
            // ByteArrayOutputStream responseBuffer = new ByteArrayOutputStream();

            // 새로운 InputStream을 사용하여 핸들러 호출
            ...
            //     System.out.println("Response preview: " + responseStr.substring(0, Math.min(responseStr.length(), 200)));
