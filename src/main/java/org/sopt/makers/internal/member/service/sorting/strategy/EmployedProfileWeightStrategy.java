 ...
 */
@Component
public class EmployedProfileWeightStrategy implements ProfileWeightStrategy {

	private static final int CAREER_WEIGHT = 5;
	private static final int INTRODUCTION_WEIGHT = 3;
	private static final int PROFILE_IMAGE_WEIGHT = 3;
