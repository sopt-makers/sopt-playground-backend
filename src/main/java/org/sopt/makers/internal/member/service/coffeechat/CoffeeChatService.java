...
public class CoffeeChatService {
    ...
    public List<CoffeeChatVo> getSearchCoffeeChatList (Long memberId, String section, String topicType, String career, String part, String search) {
        ...
        Career enumCareer = career != null ? Career.fromTitle(career) : null;
        List<CoffeeChatInfoDto> searchCoffeeChatInfo = coffeeChatRetriever.searchCoffeeChatInfo(memberId, coffeeChatSection, coffeeChatTopicType, enumCareer, part, search);
